...
* Themes: "Propulsion", "Angular", "Choices" (all premium, [by Kriesi](http://www.kriesi.at/) at ThemeForest)
...
= 1.7.1 =
Maintenance release: Added additional 'function_exists' check to avoid possible compatibility issues on upgrades.

= 1.7 =
Maintenance release: Improved bbPress 2.1+ compatibility. Updated resource links, extended theme support, added help tabs. Also, updated .pot file for translators and German translations.
...
* English - default, always included
* German (de_DE): Deutsch - immer dabei! [Download auch via deckerweb.de](http://deckerweb.de/material/sprachdateien/bbpress-forum/#bbpress-admin-bar-addition)
