...
<article id="post-<?php the_ID(); ?>" <?php post_class('post'); ?>>
	...
	<div class="entry-container">
		...
		<header class="entry-header">
			<h1 class="post-title">
				<?php if ( ! is_single() ) : ?>
					<a href="<?php the_permalink(); ?>" title="<?php echo esc_attr( sprintf( __( 'Permalink to %s', 'next-saturday' ), the_title_attribute( 'echo=0' ) ) ); ?>" rel="bookmark"><?php the_title(); ?></a>
				<?php else : ?>
					<?php the_title(); ?>
				<?php endif; ?>
			</h1>
		...
		<div class="entry-content">
			...
			<?php else : ?>
				...
				<p><span class="gallery-summary"><?php printf( _n( 'This gallery contains <a %1$s>%2$s photo</a>.', 'This gallery contains <a %1$s>%2$s photos</a>.', $total_images, 'next-saturday' ),
						'href="' . esc_url( get_permalink() ) . '" title="' . esc_attr( sprintf( __( 'Permalink to %s', 'next-saturday' ), the_title_attribute( 'echo=0' ) ) ) . '" rel="bookmark"',
